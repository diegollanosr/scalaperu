const enviarFormulario = async (e) => {
    ...
    // 1. VALIDACIÓN DE ARCHIVO (Lado del cliente)
    if (fileInput && fileInput.files.length > 0) {
        const file = fileInput.files[0];
        // Validamos tipos permitidos
        const allowedTypes = ['application/pdf', 'image/jpeg', 'image/png'];
        // Validamos tamaño (Ejemplo: máximo 5MB)
    ...
    try {
        ...
        // IMPORTANTE: No añadas headers manualmente al usar FormData con archivos.
        // El navegador detectará el 'multipart/form-data' automáticamente.
